...
import 'easy_tax_payment_succeeded.dart';


class EasyTaxPaymentConfirm extends StatelessWidget {
  final msg;

  const EasyTaxPaymentConfirm({Key key, this.msg}) : super(key: key);
                    ...
                    child: RaisedButton(
                      onPressed: (){
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => EasyTaxPaymentSucceeded(),
