...
import 'water_payment_succeeded.dart';


class WaterPaymentConfirm extends StatelessWidget {
  final msg;

  const WaterPaymentConfirm({Key key, this.msg}) : super(key: key);
                  ...
                  child: RaisedButton(
                    onPressed: (){
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => WaterPaymentSucceeded(),
