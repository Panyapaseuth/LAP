import 'package:LAP/screen/payment_screen/water_payment/water_payment_confirm.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';


class WaterPaymentDetails extends StatelessWidget {
  @override
            ...
            Expanded(
              child: ListView(
                children: <Widget>[
                  ...
                  _buildWidget(
                      'Pending Amount : ', '100,000 LAK', true),
                ],
              ),
            ),
                  ...
                  child: RaisedButton(
                    onPressed: () {
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => WaterPaymentConfirm(),
