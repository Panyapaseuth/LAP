...
class ElectricityPaymentSucceeded extends StatelessWidget {
  final msg;

  const ElectricityPaymentSucceeded({Key key, this.msg}) : super(key: key);
            ...
            Expanded(
              child: ListView(
                children: <Widget>[
                  ...
                  _buildWidget('Pending Amount : ', '100,000 LAK', true, false),
                  _buildWidget('Amount : ', amount, false, true),
    ...
    child: Row(
      ...
      children: <Widget>[
        ...
        Text(
          value,
          style: TextStyle(
            color: isAmountPending
                ? Colors.redAccent
                : isAmount ? Colors.blue : Colors.black87,
            fontFamily: 'OpenSans',
            fontSize: isAmount ? 24 : 16,
            fontWeight: isAmountPending
                ? FontWeight.w500
                : isAmount ? FontWeight.w500 : FontWeight.w400,
          ),
        ),
      ],
    ),
