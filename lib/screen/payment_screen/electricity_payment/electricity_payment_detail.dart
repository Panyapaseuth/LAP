...
import 'electricity_payment_confirm.dart';

class ElectricityPaymentDetail extends StatelessWidget {
  @override
                    ...
                    child: RaisedButton(
                      onPressed: () {
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => ElectricityPaymentConfirm(),
