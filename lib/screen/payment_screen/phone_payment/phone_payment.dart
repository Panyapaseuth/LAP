...
class PhonePayment extends StatefulWidget {
  PhonePayment({Key key, this.title}) : super(key: key);
...
class _MyHomePageState extends State<PhonePayment>
      ...
      children: <Widget>[
        ...
        Column(children: <Widget>[
          Row(
            ...
            children: [
              _buildService(() => print('Bill Payment'), 'Lao Telecom',
                  'assets/icons/LTC.png', 45, context),
              _buildService(() => print('Bill Payment'), 'Unitel',
                  'assets/icons/UNITEL.jpg', 45, context),
              _buildService(() => print('Bill Payment'),'ETL',
                  'assets/icons/ETL.png', 45, context),
            ],
          ),
          SizedBox(height: 16),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              _buildService(() => print('Bill Payment'), 'Tplus',
                  'assets/icons/TPLUS.png', 45, context),
            ],
          ),
