...
class BillPayment extends StatefulWidget {
  BillPayment({Key key, this.title}) : super(key: key);
...
class _MyHomePageState extends State<BillPayment>
      ...
      children: <Widget>[
        ...
        Column(children: <Widget>[
          Row(
            ...
            children: [
              _buildService(() => print('Bill Payment'), 'Souvanny',
                  'assets/icons/SOUVANHNY.jpg', 45, context),
            ],
          ),
